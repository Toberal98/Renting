...
?>
            ...
            onclick="llenarInfoCar('<?php echo $car['id_automovil'];?>', '<?php echo $renting;?>','<?php echo $compra;?>','<?php echo $car['marca']; ?>', '<?php echo $car['modelo']; ?>')">
                <div class="car-item">
        ...
        <?php
            ...
            echo "<div class='col-md8 mx-auto alert alert-info' role='alert'>No hay resultados.</div>";
        }
    }
