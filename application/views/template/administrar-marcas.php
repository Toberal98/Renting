        ...
        <div class="row">
            <div class="column12">            	
                ...
                <form method="post" action="<?php echo base_url().'index.php/savedata/saveMarca'?>"
                    ...
                    <br><br>
                    <label class="form-label">Area Marketing:</label>
                        <input type="text" id="aream" name="areamarketing" required>
                    <br>
                ...
                <form method="post" action="<?php echo base_url().'index.php/savedata/updateMarca'?>"
                    ...
                    <br><br>
                    <label class="form-label">Area Marketing:</label>
                        <input type="text" id="areamo" name="areamarketing" required>
                    <br>
                                    ...
                                    <tr class="t_gris<?php echo $v; ?>">
                                        ...
                                        <td >
                                            <a href="#" onclick="openformMod(
                                                                ...
                                                                '<?php echo $marca['visible']; ?>',
                                                                '<?php echo $marca['Area_Marketing']; ?>');">Editar</a>
...
<script type="text/javascript">
    ...
    function openformMod($id, $nom, $vis,$area){
        $('#listado').hide();
        $('#formularioAdd').hide();
        $('#formularioMod').show();
        $('#idMod').val($id);
