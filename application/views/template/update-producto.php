        ...
        <div class="container12">
            <div class="row agregarNuevo">
                ...
                <p class="title-sec">Caracter&iacute;sticas</p>
                    ...
                    <label><span>Categor&iacute;a:</span> <select class="cabin_grey" name="tipo_vehiculo" id="tipo_vehiculo">
                            <option value="">-Seleccione-</option>
                ...
                <div class="column6">
                    <div class="panel panel-default">
                      ...
                      <div class="panel-body">
                        ...
                        <label><span>Gps ($): </span>
                          <input type="number" id="gps_r" name="gps_r">
                        </label>
                        <label><span>Seguro ($): </span>
                          <input type="number" id="seguro_r" name="seguro_r">
                        </label>
                        <div class="center">
...
function cargarDatosCar(){
  ...
  <?php if($data_auto['aplica_renting'] == "si"): ?>
    ...
    $('#gps_r').val('<?php echo $data_auto['cargo_gps']?>');
    $('#seguro_r').val('<?php echo $data_auto['cargo_seguro']?>');
