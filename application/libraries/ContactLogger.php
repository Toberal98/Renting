...
class ContactLogger
{
    ...
    protected $sheets;
    protected $client;
    protected $spreadsheetId = '1Fwd5pdd_NAEFf3YBWVLP5j8UP62Tky5UcP3fZKUM6dpS3u6aDvEjNhmW';
    ...
    public function addLine($data_auto, $opcion, $name, $dui, $email, $phone, $cuota, $channel)
    {
        try {
            if ($this->client) {
                $range = "A1:H1";
                ...
                $values = array(
                    date('Y-m-d H:i'), $data_auto['marca'], $data_auto['modelo'], $opcion, $name, $dui, $email, $phone, 
                    $cuota, $channel
                );
